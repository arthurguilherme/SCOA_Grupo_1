...
CREATE DEFINER=`u115800830_root`@`127.0.0.1` PROCEDURE `diario_turma` (IN `cod_turma` INT)  MODIFIES SQL DATA
BEGIN
DECLARE done INT DEFAULT FALSE;
DECLARE cod_av VARCHAR(2) DEFAULT NULL;
DECLARE matr INT DEFAULT 0;
DECLARE str_query VARCHAR(9999);
DECLARE str_fields VARCHAR(9999) DEFAULT '';
DECLARE str_joins VARCHAR(9999) DEFAULT '';
DECLARE i CURSOR
FOR SELECT codigo FROM avaliacao WHERE codigo_turma = cod_turma;
DECLARE CONTINUE HANDLER FOR NOT FOUND SET done = TRUE;

SET str_query = 'SELECT a.matricula AS matricula, p.nome AS nome';
...
read_loop: LOOP
    ...
    IF done THEN
      LEAVE read_loop;
    END IF;
	SET str_fields =  CONCAT(str_fields,',',cod_av,'.nota AS ',cod_av);
    SET str_joins = CONCAT(str_joins,' LEFT JOIN nota_avaliacao ', cod_av,' ON ',cod_av,'.codigo_avaliacao = ''',cod_av,''' AND ',cod_av,'.matricula_aluno = a.matricula');
END LOOP;
CLOSE i;

SET str_query = CONCAT(str_query, str_fields,',t.faltas AS faltas, t.grau AS grau, t.situacao AS situacao',' FROM  pessoa p INNER JOIN aluno a ON p.cpf = a.cpf_pessoa\r\nINNER JOIN aluno_turma t ON a.matricula = t.matricula_aluno ', str_joins,' WHERE t.codigo_turma = ', cod_turma);

PREPARE st1 FROM str_query;
EXECUTE st1;
...
CREATE DEFINER=`u115800830_root`@`127.0.0.1` PROCEDURE `inserir_turma` (IN `cod_disc` CHAR(6), IN `vagas` INT, IN `mat_prof` INT)  BEGIN
	IF EXISTS (SELECT * FROM professor_disciplina 
              WHERE matricula_professor = mat_prof
               AND codigo_disciplina = cod_disc)
    THEN
...
CREATE DEFINER=`u115800830_root`@`127.0.0.1` PROCEDURE `lancar_grau` (IN `matr_aluno` INT, IN `cod_turma` INT)  BEGIN
...
('CC0002', 'CALCULO 2', 0, 'CC', 0),
('CC0003', 'TEORIA GERAL DA COMPUTACAO', 10, 'CC', 30);
...
INSERT INTO `pessoa` (`cpf`, `rg`, `nome`, `login`, `senha`, `perfil`) VALUES
('12074098777', '560665988758102', 'Camren', 'camren', '03ac674216f3e15c761ee1a5e255f067953623c8b388b4459e13f978d7c846f4', 2),
('121', '121', 'hhs', NULL, NULL, 0),
('12263212932', '212398437760873', 'Richmond', NULL, NULL, 2),
('12377553101', '438099690590881', 'Issac', NULL, NULL, 2),
('12815545913', '435230492393796', 'Noah', NULL, NULL, 2),
('14127583263', '590014817620524', 'Modesta', NULL, NULL, 2),
('14146246843', '580495932198957', 'Scarlettl', NULL, NULL, 2),
('14701686344', '907946350001730', 'Jamil', NULL, NULL, 2),
('14721922948', '587798522360002', 'Andrew', NULL, NULL, 0),
('15027945405', '835112123488345', 'Bridie', NULL, NULL, 0),
('17169596420', '115570661157059', 'Pat', NULL, NULL, 0),
('17787407131', '557493880024800', 'Thad', NULL, NULL, 0),
('19072102258', '184124888066305', 'Lelah', NULL, NULL, 0),
('19184512562', '171155182020738', 'Bartholome', NULL, NULL, 0),
('19563652450', '118790353644742', 'Vidal', NULL, NULL, 0),
('19751383943', '50338623051324', 'Grover', NULL, NULL, 0),
('20083994335', '902373463895896', 'Arnaldo', NULL, NULL, 0),
('20155217001', '275311611262667', 'Clovis', NULL, NULL, 0),
('20395362335', '414569578238555', 'Corrine', NULL, NULL, 0),
('20820724922', '797598677023520', 'Camryn', NULL, NULL, 0),
('22157353452', '634133267262433', 'Brandyn', NULL, NULL, 1),
('22227705021', '966778935734700', 'Shirley', NULL, NULL, 1),
('22583770420', '12716516649039', 'Courtney', NULL, NULL, 1),
('23132556262', '478206392828788', 'Wendy', NULL, NULL, 1),
('24196693921', '788270408031530', 'Branson', NULL, NULL, 1),
('24823873696', '748159550198146', 'Timmy', NULL, NULL, 1),
('24897310220', '393127021878026', 'Jadon', NULL, NULL, 1),
('25092631743', '614591767917801', 'Andreanne', NULL, NULL, 1),
('25188399727', '856184821618307', 'Dejon', NULL, NULL, 1),
('25256691169', '810706050309559', 'Christiana', NULL, NULL, 1),
('25929183554', '881831593550224', 'Audreanne', NULL, NULL, 1),
('26737969658', '119804851530740', 'Shanelle', NULL, NULL, 1),
('27593223502', '413368212517557', 'Verona', NULL, NULL, 1),
('28063163575', '353419024233913', 'Don', NULL, NULL, 1),
('28103375807', '823535261039829', 'Joany 2', NULL, NULL, 1),
('28525845002', '147138619866842', 'Ona', NULL, NULL, 0),
('28538543151', '87252682779087', 'Una', NULL, NULL, 0),
('29521784641', '77427798731045', 'Rodrick', NULL, NULL, 0),
('30592526412', '543312952789581', 'Leola', NULL, NULL, 0),
('32709441830', '126518424872515', 'Nola', NULL, NULL, 0),
('33333333333', '44444444', 'Cicrano Pereira2', NULL, NULL, 2),
('34082483169', '630906079911316', 'Mathias', NULL, NULL, 0),
('34957679402', '328983034395819', 'Elza', NULL, NULL, 0),
('35321450854', '149019454287158', 'Kieran', NULL, NULL, 0),
('35481900887', '402076748868243', 'Bennie', NULL, NULL, 0),
('35901307397', '261977624992012', 'Madge', NULL, NULL, 0),
('37330874924', '66573655455787', 'Jasper', NULL, NULL, 0),
('38118755320', '345263753697896', 'Bonita', NULL, NULL, 0),
('39256294237', '687404817360349', 'Reagan', NULL, NULL, 0),
('39379835170', '666132871125721', 'Krystel', NULL, NULL, 0),
('41827069512', '969824721156619', 'Granville', NULL, NULL, 0),
('42238581097', '20045720482658', 'Henriette', NULL, NULL, 0),
('42495135838', '606901167751186', 'Wilma', NULL, NULL, 0),
('43212005578', '618484466395651', 'Dusty', NULL, NULL, 0),
('43856517308', '566334162379821', 'Reed', NULL, NULL, 0),
('43932114086', '407714887218963', 'Gisselle', NULL, NULL, 0),
('44908801341', '431057816833878', 'Bryana', NULL, NULL, 0),
('44932501431', '428705679092349', 'Jared', NULL, NULL, 0),
('45361577471', '70574849675305', 'Edmond', NULL, NULL, 0),
('45418748632', '251017641946673', 'Lauren', NULL, NULL, 0),
('45950314609', '757764345834859', 'Holly', NULL, NULL, 0),
('46797447154', '23541428421934', 'Nikki', NULL, NULL, 0),
('47786186055', '694237901051011', 'Lourdes', NULL, NULL, 0),
('48001376870', '682416645027697', 'Missouri', NULL, NULL, 0),
('48192715437', '836032460436949', 'Immanuel', NULL, NULL, 0),
('49368551704', '316369480651078', 'Millie', NULL, NULL, 0),
('49455457718', '513570986640536', 'Liana', NULL, NULL, 0),
('50779383960', '532019644379615', 'Madeline', NULL, NULL, 0),
('50854770839', '369488630075938', 'Filomena', NULL, NULL, 0),
('51473583777', '6632308102626', 'Garland', NULL, NULL, 0),
('51993723544', '510671689912883', 'Misty', NULL, NULL, 0),
('53611699077', '551389846115683', 'Bennie', NULL, NULL, 0),
('53727233409', '644518838541375', 'Jaydon', NULL, NULL, 0),
('54350182538', '410226621409464', 'David', NULL, NULL, 0),
('55420597808', '284331491253752', 'Amelie', NULL, NULL, 0),
('55744585601', '840247152444078', 'Lempi', NULL, NULL, 0),
('56208534207', '244574422790254', 'Horacio', NULL, NULL, 0),
('57018867631', '447344146236363', 'Dan', NULL, NULL, 0),
('57213477873', '904929284889044', 'Talon', NULL, NULL, 0),
('59253494813', '982847643383882', 'Laurel', NULL, NULL, 0),
('60052132233', '874132524974023', 'Deontae', NULL, NULL, 0),
('60156531590', '459119303709723', 'Christine', NULL, NULL, 0),
('60219813924', '192621582122002', 'Leta', NULL, NULL, 0),
('60818600613', '433063659138667', 'Nora', NULL, NULL, 0),
('61391398724', '884654186655663', 'Everardo', NULL, NULL, 0),
('61893430227', '336071003911913', 'Zelma', NULL, NULL, 0),
('62471508441', '260536707378923', 'Abigayle', NULL, NULL, 0),
('62643340229', '279992452331611', 'Audra', NULL, NULL, 0),
('62721576044', '347475744051755', 'Casper', NULL, NULL, 0),
('62977357332', '442586447582580', 'Trycia', NULL, NULL, 0),
('63602080278', '33018872779276', 'Tomasa', NULL, NULL, 0),
('63927119804', '718547340587505', 'Teagan', NULL, NULL, 0),
('64531608091', '32969854521151', 'Avis', NULL, NULL, 0),
('65229722029', '45404635795081', 'Maureen', NULL, NULL, 0),
('65378960097', '93010544049449', 'Johanna', NULL, NULL, 0),
('66105188801', '767628100562012', 'Enola', NULL, NULL, 0),
('66384868116', '499645621084815', 'Octavia', NULL, NULL, 0),
('66619992752', '986850148378871', 'Jazmin', NULL, NULL, 0),
('66818515749', '190651286112972', 'Weldon', NULL, NULL, 0),
('68404467776', '974142393229218', 'Rigoberto', NULL, NULL, 0),
('69514595013', '721275019687600', 'Maverick', NULL, NULL, 0),
('70000769653', '661830019002469', 'Delaney', NULL, NULL, 0),
('70028395371', '534877647958799', 'Teagan', NULL, NULL, 0),
('70038462595', '739922518065302', 'Orin', NULL, NULL, 0),
('71128881184', '29472667889462', 'Billie', NULL, NULL, 0),
('71464740567', '663201893448001', 'Cecilia', NULL, NULL, 0),
('73186993847', '998421259788382', 'Emilia', NULL, NULL, 0),
('74320104097', '561330771004367', 'Angelita', NULL, NULL, 0),
('74766544128', '609180174640690', 'Beryl', NULL, NULL, 0),
('74925184498', '924874114683415', 'Vida', NULL, NULL, 0),
('76099714222', '270174396595814', 'Mckayla', NULL, NULL, 0),
('76428835507', '430334598561231', 'Irwin', NULL, NULL, 0),
('77007315721', '290251006769637', 'Paige', NULL, NULL, 0),
('78050205442', '675181676089349', 'Jarrett', NULL, NULL, 0),
('78308031004', '787755489098425', 'Heber', NULL, NULL, 0),
('78483879152', '331820170224851', 'Asia', NULL, NULL, 0),
('79793206188', '207800275087356', 'Sidney', NULL, NULL, 0),
('80350334321', '998272543054901', 'Howell', NULL, NULL, 0),
('81074320400', '764807116389274', 'Carlos', NULL, NULL, 0),
('82273858620', '304744631168432', 'Scottie', NULL, NULL, 0),
('82340173216', '457242989092547', 'Zella', NULL, NULL, 0),
('82998505193', '943956622135204', 'Thea', NULL, NULL, 0),
('83258767384', '289449712700313', 'Rusty', NULL, NULL, 0),
('83963830520', '718032526311775', 'Therese', NULL, NULL, 0),
('84215764908', '759758276735018', 'Lurline', NULL, NULL, 0),
('84746231138', '919550912233793', 'Wilbert', NULL, NULL, 0),
('85261496156', '927102635320689', 'Levi', NULL, NULL, 0),
('85610488098', '585738008903443', 'Noah', NULL, NULL, 0),
('86588657316', '495673240668450', 'Adaline', NULL, NULL, 0),
('86959979393', '527125171096478', 'Freddie', NULL, NULL, 0),
('87548700223', '994984777224664', 'Dejah', NULL, NULL, 0),
('87705701548', '454070433355971', 'Shakira', NULL, NULL, 0),
('89072099328', '816905712685030', 'Justen', NULL, NULL, 0),
('89258943001', '771372497214728', 'Chanel', NULL, NULL, 0),
('90100047778', '443913156556793', 'Rita', NULL, NULL, 0),
('90804178971', '68809728169192', 'Angela', NULL, NULL, 0),
('91340827403', '937171699442486', 'Jadyn', NULL, NULL, 0),
('91827751613', '380827398393303', 'Dameon', NULL, NULL, 0),
('91936588535', '363475792742230', 'Lucy', NULL, NULL, 0),
('92280213534', '318082453945858', 'Reid', NULL, NULL, 0),
('93063115204', '174455965367766', 'Christy', NULL, NULL, 0),
('93693691574', '733177677751518', 'Fatima', NULL, NULL, 0),
('95434308590', '936939817773074', 'Myrtle', NULL, NULL, 0),
('95572847624', '368404287579469', 'Moshe', NULL, NULL, 0),
('96388268098', '360460424009296', 'Gerhard', NULL, NULL, 0),
('96759557641', '151174178451506', 'Katrine', NULL, NULL, 0),
('96811692333', '976898014452825', 'Green', NULL, NULL, 0),
('96867451154', '826339437703395', 'Oleta', NULL, NULL, 0),
('97196880355', '804190893395183', 'Margarita', NULL, NULL, 0),
('97917767862', '527920878787731', 'Albert', NULL, NULL, 0),
('98947435865', '286949818747428', 'Carolina', NULL, NULL, 0),
('99127612056', '28246705824923', 'Royce', NULL, NULL, 0);
...
CREATE TABLE `professor_disciplina` (
  ...
  `codigo_disciplina` char(6) CHARACTER SET latin1 NOT NULL
...
ALTER TABLE `professor_disciplina`
  ADD PRIMARY KEY (`matricula_professor`,`codigo_disciplina`),
  ADD KEY `prof_disc_coddisc` (`codigo_disciplina`);
...
--
ALTER TABLE `aluno`
  MODIFY `matricula` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `aluno`
  ADD CONSTRAINT `aluno_FK` FOREIGN KEY (`cpf_pessoa`) REFERENCES `pessoa` (`cpf`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `professor_disciplina`
  ADD CONSTRAINT `prof_disc_coddisc` FOREIGN KEY (`codigo_disciplina`) REFERENCES `disciplina` (`codigo`),
  ADD CONSTRAINT `prof_disc_matprof` FOREIGN KEY (`matricula_professor`) REFERENCES `professor` (`matricula`);
